...
空重：6356 kg(14013 lb)  
最小重量（无弹药、10%燃油）：6662 kg(14687 lb)  
...
—自动混合比控制系统会在混合比控制杆放于自动富油（70%）时，将混合比调为最佳的浓度。在飞行中为减小燃油消耗，可将混合比控制杆放至自动贫油（30%）上。当自动混合比控制系统故障时，应将控制杆推至完全富油（控制杆向前推满）上。在关闭发动机时，将控制杆收至关断（0%）上。  

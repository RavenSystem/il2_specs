...
Peso mínimo (sin munición, 10%25 de combustible): 3560 kg (7849 lb)  
...
- El motor cuenta con un modo impulso de emergencia (WEP). Para activar este modo es necesario tirar de la palanca «PULL» del «Boost Control» y poner la palanca de potencia es su posición más adelantada (al 100%25).  
...
- El motor está equipado con un sistema de control automático de la mezcla que la mantiene en su grado óptimo cuando la palanca de control de la mezcla está en la posición «FULL RICH» (100%25). Para apagar el motor, la palanca debe situarse en la posición «Cut Off» (0%25).  

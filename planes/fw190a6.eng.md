...
- G-3 and G-3/R-5 modification includes C3 additional fuel injection system. When engaged, it increases pressure to 1.65 ATA (10 minutes time limit). This system can be turned on by engine boost command only at 100% throttle, with automatic propeller pitch control enabled and at altitudes lower than 1 km.  
